...
for i = 1:n_intervals
    ...
    [t_abierto, Y_abierto] = ode23(@(t, Y) ec_differential(t,Y,E,-1), [t_end_cerrado, t_end_abierto], [Vc_t_final,Il_t_final]);
...
%sub
%plot(tiempo+1.072e-3, data,'g', 'DisplayName', 'Excel Data');
%sobre
