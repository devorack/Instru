...
for i = 1:n_intervals
    ...
    Il_t_final = Y_cerrado(end, 1);
    Vc_t_final = Y_cerrado(end, 2);
    ...
    results_Il = [results_Il; [t_cerrado, Y_cerrado(:, 1); t_abierto, Y_abierto(:, 1)]];
    results_Vc = [results_Vc; [t_cerrado, Y_cerrado(:, 2); t_abierto, Y_abierto(:, 2)]];
